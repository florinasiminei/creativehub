...
type WhatsAppButtonProps = {
  phone: string; // e.g., 40712345678 (no +)
  message?: string;
};

export default function WhatsAppButton({ phone, message = "Bună! Sunt interesat de proprietate." }: WhatsAppButtonProps) {
